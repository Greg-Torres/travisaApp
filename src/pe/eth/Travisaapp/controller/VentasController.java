...
public class VentasController {
    ...
    public static boolean registrarPedido(ventas ve, ArrayList<DetalleVenta> dvlist) throws SQLException {
...
//retorna una fila con el producto del codigo pedido
       ...
       String msje=     vsi.insertar(ve);
            //recorrer el arreglo de detalles e insertar cada uno de los detalles
            if(msje.equals("exito")){
            for (DetalleVenta d : dvlist) {
